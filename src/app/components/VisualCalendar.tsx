              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    className="px-3 py-2 rounded-xl bg-neutral-950 text-white dark:bg-white dark:text-neutral-950 text-xs font-black hover:opacity-90 active:scale-95 transition-all shadow-xs flex items-center gap-1.5 cursor-pointer"
                  >
                  ...
                  {onEtkinlikSil && (
                    <button
                      onClick={() => onEtkinlikSil(item.id)}
                      className="p-2 rounded-xl border border-rose-200 dark:border-rose-950 bg-rose-50 text-rose-600 dark:bg-rose-950/40 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-900/60 transition-all active:scale-95 flex items-center gap-1 cursor-pointer text-xs font-bold"
                      title="Etkinliği Sil"
                    >
