  ...
  return (
    <div className="w-full min-h-screen bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100 flex flex-col justify-start items-center p-8 transition-colors duration-300">
      <div className="w-full max-w-4xl space-y-6">
        ...
        {aramaKelimesi.trim() !== "" && (
          <div className="w-full bg-white/80 border border-dashed border-neutral-200 dark:bg-neutral-900/40 dark:border-neutral-700 rounded-2xl p-4 space-y-3 shadow-2xs">
        ...
        <div className="w-full bg-white border border-neutral-200/60 rounded-3xl p-8 space-y-8 dark:bg-neutral-900/60 dark:border-neutral-800">
          <div className="flex items-center justify-center gap-6 relative">
            <div className="flex items-center gap-3">
              <button
                onClick={kaydediyor ? kaydiDurdur : kaydiBaslat}
                className={`w-20 h-20 rounded-full flex items-center justify-center transition-all duration-300 shadow-md border ${
                  kaydediyor
              ...
              >
                {kaydediyor ? (
                  <span className="text-sm font-black tracking-widest text-red-600 dark:text-red-500">DUR</span>
                ) : (
                  <>
                    <svg className="w-7 h-7 text-white block dark:hidden" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                    ...
                    <svg className="w-7 h-7 text-neutral-950 hidden dark:block" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 0 3-3v-6a3 3 0 0 0-6 0v6a3 3 0 0 0 3 3Z" />
                    </svg>
                  </>
                )}
              ...
              {kaydediyor && (
                <span className="text-xs font-black px-3 py-1 bg-red-50 text-red-600 border border-red-100 rounded-full animate-pulse absolute left-4 md:left-8 dark:bg-red-950/50 dark:text-red-400 dark:border-red-900">
                  {formatSure(sure)}
                </span>
              )}
            </div>
            ...
            <div>
              ...
              <button
                ...
                className="w-20 h-20 rounded-full border bg-neutral-50 border-neutral-200 text-neutral-800 hover:text-neutral-950 hover:border-neutral-950 hover:bg-white flex items-center justify-center transition-all shadow-2xs group hover:scale-110 active:scale-95 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-300 dark:hover:text-white"
                title="Ses Dosyasi Yükle"
              >
                <svg className="w-7 h-7 transition-transform group-hover:scale-110 text-neutral-800 dark:text-white" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-center gap-1.5 h-16 bg-neutral-100 border border-neutral-200/50 rounded-2xl py-10 dark:bg-neutral-950 dark:border-neutral-850">
          ...
          <div className="space-y-4">
            ...
            {sesUrl ? (
              <div className="p-5 bg-neutral-50 border border-neutral-200 rounded-2xl flex flex-col lg:flex-row items-center gap-4 justify-between shadow-3xs dark:bg-neutral-950 dark:border-neutral-800">
              ...
              <div className="text-center p-8 border border-dashed border-neutral-200 rounded-2xl text-neutral-400 text-xs font-bold tracking-wide dark:bg-neutral-950/20 dark:border-neutral-800">
        ...
        <div className="w-full border-t border-neutral-200 dark:border-neutral-800 pt-6">
          <div className="text-center p-8 border border-dashed border-neutral-200 dark:border-neutral-800 rounded-3xl text-neutral-400 dark:text-neutral-500 text-xs font-bold">
